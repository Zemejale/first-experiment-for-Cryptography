...
THRESHOLD_VALUE = 7#If the result of pairwise XOR is more than 7 letters, the character is considered as a space, and the change of the value will affect the final result
